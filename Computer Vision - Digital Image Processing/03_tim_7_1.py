...
Original file is located at
    https://colab.research.google.com/drive/1JStdrmiSNMfe-gZ60HCxEqCuzGwyGZJS
...
- [V] Ubah kanal warna dari BGR ke RGB dengan cv2.COLOR_BGR2RGB
- [V] Ubah kanal warna dari BGR ke grayscale dengan cv2.COLOR_BGR2GRAY
- [V] Ubah kanal warna dari grayscale ke binary dengan cv2.THRESH_BINARY
- [V] Plot histogram dari gambar asli
- [V] Plot histogram dari gambar grayscale
- [V] PERTANYAAN: Apa keunggulan operasi Max Pooling dari PyTorch dibandingkan yang dari Scikit-image?
- [V] Panggil ulang block_reduce(), tetapi dengan func=np.min
- [V] Panggil ulang block_reduce().astype(int), tetapi dengan func=np.mean
- [V] PERTANYAAN: Apa perbedaan antara Min Pooling dan Average Pooling?
- [V] Panggil fungsi apply_clahe_rgb() dan isi parameter img="photo1.jpeg"
- [V] PERTANYAAN: Apa keunggulan menggunakan CLAHE (daripada Max Pooling) untuk mencerahkan gambar bernuansa gelap?
- [V] Berikan nama file` ke gambar yang sudah disempurnakan dengan CLAHE, diakhiri dengan ekstensi .png
